...
const script = {
  ...
  livingRoomCousinsMeetup: [
    ...
    {
      speaker: "Narrator",
      text: "He opens his eyes, now in the familiar mindscape.",
    },
    { speaker: "Nate", text: "Huh." },
    { speaker: "Nate", text: "Im here. again." },
    {
      speaker: "Narrator",
      text: "Suddenly, RedSlime appears with ZFentom and Boruto",
    },
    ...
    {
      speaker: "Narrator",
      text: "Slime snaps his fingers. The ground is no longer shaking",
    },
    { speaker: "Redslime", text: "Hey, wait a minute. Your not whole." },
    { speaker: "Nate", text: "What?" },
    {
      speaker: "Boruto",
      text: "Hmm, interesting. Never seen seperation before.",
    },
    { speaker: "Nate", text: "???" },
