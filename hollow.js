...
const script = {
  ...
  livingRoomCousinsMeetup: [
    ...
    { speaker: "Narrator", text: "Ben, digs through the food. While nate thinks about last night"},
    ...
    { speaker: "Nate", text: "I'll just sleep for now."},
    { speaker: "Nate", text: "Man, Am i tired."},
    { speaker: "Narrator", text: "Nate manages to sleep with his mind full"},
    { speaker: "Narrator", text: "He opens his eyes, now in the familiar mindscape."},
    { speaker: "Nate", text: "Huh."},
    { speaker: "Nate", text: "Im here. again."},
    { speaker: "Narrator", text: "Suddenly, RedSlime appears with ZFentom and Boruto"},
    { speaker: "Redslime", text: "Yes you are!"},
    { speaker: "ZFentom", text: "Who is this guy again?"},
    { speaker: "Redslime", text: "Apparently me according to boruto."},
    { speaker: "ZFentom", text: "That dosent mak-"},
    { speaker: "Redslime", text: "He came into the mindscape"},
    { speaker: "ZFentom", text: "Oh. So you should know everything by now."},
    { speaker: "Nate", text: "... Yes."},
    { speaker: "ZFentom", text: "So what happens?"},
    { speaker: "Redslime", text: "We shouldnt-", skip: true },
    { speaker: "Nate", text: "I dont want to tell."},
    { speaker: "ZFentom", text: "Its Bad?" },
    { speaker: "Nate", text: "..." },
    { speaker: "Redslime", text: "Anyway" },
    { speaker: "Narrator", text: "Suddenly, the ground shakes." },
    { speaker: "Boruto", text: "Slime quicken up, We dont have time." },
    { speaker: "Redslime", text: "Ah right, sorry. One second" },
    { speaker: "Narrator", text: "Slime snaps his fingers. The ground is no longer shaking" },
    { speaker: "Redslime", text: "Hey, wait a minute. Your not whole."},
    { speaker: "Nate", text: "What?"},
